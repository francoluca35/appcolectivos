...
export default function AdminAuth() {
  ...
  return (
    <div
      ...
      style={{ backgroundImage: "url('/fondo-rapiflex.jpg')" }} // 🔁 Cambia por la ruta correcta de tu imagen
    >
      <div className="bg-yellow-400/80 p-8 rounded-xl w-80 flex flex-col items-center shadow-lg backdrop-blur-sm">
        <img src="/logo-rapiflex.png" alt="Rapiflex Logo" className="w-32 mb-4" /> {/* Reemplazá con tu logo */}
