  ...
  <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-1 lg:w-1/4">
    {botones.map((btn, i) => (
      <button
        ...
        className="bg-red-500 rounded-xl w-full h-32 flex flex-col items-center justify-center shadow-md hover:bg-red-600 transition"
      >
        <img src={btn.icono} alt={btn.texto} className="w-8 h-8 mb-2" />
