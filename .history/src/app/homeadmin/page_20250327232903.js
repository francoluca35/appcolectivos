...
export default function HomeAdmin() {
  ...
  const botones = [
    { texto: "Agregar viaje", ruta: "/agregarviaje", icono: "/Assets/agregar.png" },
    { texto: "Lista de viajes", ruta: "/listaviajes", icono: "/Assets/list.png" },
    { texto: "Check de pagos", ruta: "/checkpagos", icono: "/Assets/check.png" },
    { texto: "Bandeja de mensajes", ruta: "/mensajes", icono: "/Assets/inbox.png" },
    ...
    <div className="min-h-screen bg-white p-4 flex flex-col items-center gap-6">
      ...
      <div className="w-full flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          <img src="/avatar.png" alt="Avatar" className="w-10 h-10 rounded-full border text-white" />
