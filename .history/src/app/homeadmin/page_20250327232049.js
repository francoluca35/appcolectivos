      ...
      <div className="grid grid-cols-2 gap-4 w-full justify-items-center">
        {botones.map((btn, i) => (
          <button
            ...
            className="bg-red-500 rounded-xl w-36 h-36 flex flex-col items-center justify-center shadow-md hover:bg-red-600 transition"
          >
            <img src={btn.icono} alt={btn.texto} className="w-10 h-10 mb-2" />
