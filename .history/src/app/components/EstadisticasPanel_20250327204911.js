  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
      <div className="bg-white shadow-md rounded-lg p-4 text-center">
        <p className="text-sm text-black">Viajes realizados</p>
        <p className="text-2xl font-bold text-blue-600">{stats.cantidadViajes}</p>
      </div>
      <div className="bg-white shadow-md rounded-lg p-4 text-center">
        <p className="text-sm text-black">Pasajeros (acum.)</p>
        <p className="text-2xl font-bold text-green-600 z-10">{stats.cantidadPasajeros}</p>
      </div>
      <div className="bg-white shadow-md rounded-lg p-4 text-center">
