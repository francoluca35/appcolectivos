...
export default function ViajesListContent() {
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex justify-center items-center z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-sm animate-fadeIn">
            ...
            <p className="text-center text-gray-900 mb-6">Esta acción no se puede deshacer.</p>
            <div className="flex justify-center gap-4">
              <button
                onClick={cancelarEliminacion}
                className="px-4 py-2 bg-blue-500 hover:bg-blue-300 rounded transition"
              >
                Cancelar
              </button>
              <button
